...
<style>
/* CSS ส่วน Slideshow และ Card (คงเดิมตามที่คุณส่งมา) */
...
<div class="card-container" style="font-family: 'Kanit', sans-serif;">
    <div class="card">
        ...
        <a href="product_detail.php?name=<?= urlencode('เสื้อฮู้ดสีดำ'); ?>" class="btn-detail">ดูรายละเอียด</a>
    </div>

    <div class="card">
        <img src="uploads/เสื้อสเวกเตอร์สีชมพู.jpg">
        <h4>เสื้อสเวตเตอร์สีชมพู</h4>
        <div class="price">220 บาท</div>
        <a href="product_detail.php?name=<?= urlencode('เสื้อสเวตเตอร์สีชมพู'); ?>" class="btn-detail">ดูรายละเอียด</a>
    </div>
    ...
    <div class="card">
        ...
        <a href="product_detail.php?name=<?= urlencode('แจ็คเก็ตยีนส์สีฟ้าอ่อน'); ?>" class="btn-detail">ดูรายละเอียด</a>
    </div>
</div>
